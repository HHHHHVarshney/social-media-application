...
class postAdapter(options: FirestoreRecyclerOptions<Post>, val listener: IPostAdapter) : FirestoreRecyclerAdapter<Post, postAdapter.viewHolder>(
    options
) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val viewHolder =  viewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_post,parent,false))
